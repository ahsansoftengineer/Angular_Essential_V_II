...
export abstract class BaseExcel extends BaseForm {
  ...
  columnPatternCashDeposit = ['Date', 'Bank Deposit Slip No.', 'Branch Code', "Donor Name", 'Area/Majlis Code', 'CNIC No.', 'Contact No', 'Email', 'Nature of Donation', 'Payment Mode', 'Instrument No', 'Cheque Date', 'Drawn on Bank', 'Detail of Specific Purpose', 'Amount']
  CheckPattern(
