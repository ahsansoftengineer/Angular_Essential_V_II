...
export class FormHelperService {
  ...
  // behave like getter don't use it to add / remove control
  // don't use them for modifying purpose
  // can only be used for 
  _getGroup(group: string){
    return this._fs._form.get(group) as FormGroup
  }
  _getArray(array: string){
    return this._fs._form.get(array) as FormArray
  }
  _getControl(control: string){
    return this._fs._form.get(control) as FormControl
  }
